...
SRC_URL=https://mirrors.edge.kernel.org/pub/linux/kernel/people/tytso/e2fsprogs/v1.45.3/$(SRC_NAME).tar.xz
...
ifneq (,$(findstring musl,$(CROSS_COMPILE)))
